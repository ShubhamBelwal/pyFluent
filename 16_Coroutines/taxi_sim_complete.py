...
class Simulator:
    ...
    def run(self, end_time):
        """Schedule and display events till time is up"""
        ...
        while sim_time < end_time:
            ...
            sim_time, proc_id, previous_action = current_event  # time = yield Event(time, ident, "pick up passenger")
...
def compute_duration(previous_action):
    ...
    if previous_action in ["leave garage", "drop off passenger"]:
        ...
        raise ValueError("Unknown previous_action: ", previous_action)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--end_time', type=int,
                        ...
                        help="simulation end_time; default = {}".format(DEFAULT_END_TIME))
